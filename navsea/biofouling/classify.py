...
from .model import UNet, Adam


class BiofoulingClassfier:
    def __init__(self, image_size=128):
        self.imgsize=image_size
        self.weight_file=os.path.join(os.path.dirname(__file__), '../model/best_Unet_biofouling_model.h5')
        ...
        self.weight_file = '\\pythonAWS\\navsea\\model\\best_Unet_model_biofouling.h5'
